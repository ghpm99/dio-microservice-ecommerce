 ...
 */
package br.henrique.ecommerce.checkout.event;
...
public class CheckoutCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7615415312763079694L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CheckoutCreatedEvent\",\"namespace\":\"br.henrique.ecommerce.checkout.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[\"string\"]},{\"name\":\"status\",\"type\":[\"string\"]}]}");
   ...
   */
  public static br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder() {
    return new br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder(br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder other) {
    if (other == null) {
      return new br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder newBuilder(br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent other) {
    if (other == null) {
      return new br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CheckoutCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder setStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.checkout.event.CheckoutCreatedEvent.Builder clearStatus() {
      status = null;
