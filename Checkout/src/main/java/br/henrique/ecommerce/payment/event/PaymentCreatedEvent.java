...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8801941744307216073L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentCreatedEvent\",\"namespace\":\"br.henrique.ecommerce.payment.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[\"string\"]},{\"name\":\"checkoutStatus\",\"type\":[\"string\"]},{\"name\":\"paymentCode\",\"type\":[\"string\"]}]}");
   ...
   */
  public static br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder newBuilder() {
    return new br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder newBuilder(br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder other) {
    if (other == null) {
      return new br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder();
    } else {
      return new br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder newBuilder(br.henrique.ecommerce.payment.event.PaymentCreatedEvent other) {
    if (other == null) {
      return new br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder();
    } else {
      return new br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.henrique.ecommerce.payment.event.PaymentCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder setCheckoutStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder clearCheckoutStatus() {
      checkoutStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.PaymentCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
