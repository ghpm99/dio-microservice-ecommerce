 ...
 */
package br.henrique.ecommerce.payment.event;
...
public class CheckoutCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8644982778735028294L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CheckoutCreatedEvent\",\"namespace\":\"br.henrique.ecommerce.payment.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[\"string\"]},{\"name\":\"checkoutStatus\",\"type\":[\"string\"]},{\"name\":\"paymentCode\",\"type\":[\"string\"]}]}");
   ...
   */
  public CheckoutCreatedEvent(java.lang.Object checkoutCode, java.lang.Object checkoutStatus, java.lang.Object paymentCode) {
   ...
   */
  public static br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder newBuilder() {
    return new br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder();
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder newBuilder(br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder other) {
    if (other == null) {
      return new br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder();
    } else {
      return new br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder newBuilder(br.henrique.ecommerce.payment.event.CheckoutCreatedEvent other) {
    if (other == null) {
      return new br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder();
    } else {
      return new br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CheckoutCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.henrique.ecommerce.payment.event.CheckoutCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder setCheckoutStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder clearCheckoutStatus() {
      checkoutStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.henrique.ecommerce.payment.event.CheckoutCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
